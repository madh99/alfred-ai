...
export const AlfredConfigSchema = z.object({
  ...
  backup: z.object({
    ...
    restore_via_chat: z.coerce.boolean().default(false),
    include_tokens: z.coerce.boolean().default(true),
  ...
  mikrotik: z.object({
    ...
    polling_interval: z.coerce.number().default(5),
    auto_incident: z.coerce.boolean().default(true),
    cpu_warning_pct: z.coerce.number().default(80),
    ram_warning_pct: z.coerce.number().default(85),
    host: z.string().optional(),
    username: z.string().optional(),
    password: z.string().optional(),
    port: z.coerce.number().optional(),
  ...
  commvault: z.object({
    ...
    username: z.string().optional(),
    password: z.string().optional(),
    verifyTls: z.coerce.boolean().default(true),
    confirmation_mode: z.coerce.boolean().default(false),
    polling_interval: z.coerce.number().default(30),
    auto_retry_failed: z.coerce.boolean().default(true),
    auto_incident: z.coerce.boolean().default(true),
    storage_warning_pct: z.coerce.number().default(85),
    sla_rpo_hours: z.coerce.number().default(24),
  }).optional(),
