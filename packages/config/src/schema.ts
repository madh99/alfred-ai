...
export const AlfredConfigSchema = z.object({
  ...
  mikrotik: z.object({
    enabled: z.boolean().default(false),
    confirmation_mode: z.boolean().default(false),
    polling_interval: z.number().default(5),
    auto_incident: z.boolean().default(true),
    cpu_warning_pct: z.number().default(80),
    ram_warning_pct: z.number().default(85),
    host: z.string().optional(),
    username: z.string().optional(),
    password: z.string().optional(),
  ...
  commvault: z.object({
    ...
    confirmation_mode: z.boolean().default(false),
    polling_interval: z.number().default(30),
    auto_retry_failed: z.boolean().default(true),
    auto_incident: z.boolean().default(true),
    storage_warning_pct: z.number().default(85),
    sla_rpo_hours: z.number().default(24),
  }).optional(),
