...
const ENV_MAP: Record<string, string[]> = {
  ...
  ALFRED_LOG_FILE_ENABLED: ['logger', 'file', 'enabled'],
  ALFRED_LOG_FILE_PATH: ['logger', 'file', 'path'],
  ALFRED_LOG_FILE_MAX_SIZE: ['logger', 'file', 'maxSize'],
  ALFRED_LOG_FILE_MAX_FILES: ['logger', 'file', 'maxFiles'],
  ALFRED_LOG_FILE_FREQUENCY: ['logger', 'file', 'frequency'],
  ...
  // v696 — Sandbox + Live-Preview (opt-in)
  ALFRED_SANDBOX_ENABLED: ['sandbox', 'enabled'],
  ALFRED_SANDBOX_DEFAULT_MODE: ['sandbox', 'defaultMode'],
  ALFRED_SANDBOX_DEFAULT_MERGE_STRATEGY: ['sandbox', 'defaultMergeStrategy'],
  ALFRED_SANDBOX_MAX_PARALLEL_PER_USER: ['sandbox', 'maxParallelPerUser'],
  ALFRED_SANDBOX_DISK_QUOTA_USER_MB: ['sandbox', 'diskQuotaPerUserMb'],
  ALFRED_SANDBOX_DISK_QUOTA_SANDBOX_MB: ['sandbox', 'diskQuotaPerSandboxMb'],
  ALFRED_SANDBOX_PORT_RANGE_START: ['sandbox', 'hostPortRangeStart'],
  ALFRED_SANDBOX_PORT_RANGE_END: ['sandbox', 'hostPortRangeEnd'],
  ALFRED_SANDBOX_IDLE_TIMEOUT_MIN: ['sandbox', 'idleTimeoutMin'],
  ALFRED_SANDBOX_CLEANUP_AFTER_HOURS: ['sandbox', 'cleanupAfterHours'],
  ALFRED_SANDBOX_WORKTREE_BASE_PATH: ['sandbox', 'worktreeBasePath'],
  ALFRED_SANDBOX_CONTAINER_IMAGE: ['sandbox', 'containerImage'],
  ALFRED_SANDBOX_PNPM_STORE_PATH: ['sandbox', 'pnpmStorePath'],
  // Personality
  ...
  ALFRED_COMMVAULT_API_TOKEN: ['commvault', 'apiToken'],
  ALFRED_COMMVAULT_USERNAME: ['commvault', 'username'],
  ALFRED_COMMVAULT_PASSWORD: ['commvault', 'password'],
  ALFRED_COMMVAULT_VERIFY_TLS: ['commvault', 'verifyTls'],
  ALFRED_COMMVAULT_CONFIRMATION_MODE: ['commvault', 'confirmation_mode'],
  ALFRED_COMMVAULT_POLLING_INTERVAL: ['commvault', 'polling_interval'],
  ALFRED_COMMVAULT_AUTO_RETRY: ['commvault', 'auto_retry_failed'],
  ALFRED_COMMVAULT_AUTO_INCIDENT: ['commvault', 'auto_incident'],
  ALFRED_COMMVAULT_STORAGE_WARNING_PCT: ['commvault', 'storage_warning_pct'],
  ALFRED_COMMVAULT_SLA_RPO_HOURS: ['commvault', 'sla_rpo_hours'],
  // Backup
