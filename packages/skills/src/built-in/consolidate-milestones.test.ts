...
interface FakeItem { id: string; title: string; roadmapMilestone?: string; roadmapOrder?: number; createdAt: string; status: string; }

function makeSkill(items: FakeItem[], retagCalls: Array<{ id: string; milestone?: string | null; order?: number | null }>): ProjectSkill {
  const repo = {
...
const ITEMS: FakeItem[] = [
  ...
  { id: 'a2', title: 'A2', roadmapMilestone: 'Feature: Album-Tracker', roadmapOrder: 2, createdAt: '2026-01-02', status: 'done' },
