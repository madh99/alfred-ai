...
export { SocialSkill, SocialProvider, isCompanionFormat, findRecentChannelDuplicate, leadHatTiefe, staggeredAdhocSlot, TelegramChannelProvider, RestProvider, YouTubeProvider, MetaProvider, XProvider, BlueskyProvider, BEST_PRACTICE_SLOTS, effectiveSlots, extractTrailingHashtags, mergeHashtags, languageName, isNearDuplicateTitle, storyIdentity, cosineSimilarity, applyImageOverlays, bakeReelEndCard, buildVideoWatermark, cropToRatio, resolveImageBranding, parseOverlayCorner, recolorSvg, loadSharp, type OverlaySpec } from './built-in/social/index.js';
