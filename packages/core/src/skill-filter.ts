...
const CATEGORY_KEYWORDS: Record<Exclude<SkillCategory, 'core'>, RegExp> = {
  ...
  identity:     /\b(link|verknüpf|cross.?platform|identity|identität|user|benutzer|nutzer|rolle|role|invite|einlad|connect|verbind|whoami|wer\s+bin\s+ich|profil|registrier|onboard|deaktiv|aktivier)\b/i,
  mcp:          /\bmcp\b/i,
};
